...
const NavBar: React.FC = () => {
  return (
    <nav className="w-full h-[61px] px-6 bg-[#E4E4E4] border-3 border-solid backdrop-blur-[42px] flex justify-center items-center relative">
      <div className="h-full flex justify-between items-center w-full max-w-[1440px]">
        <div className="flex justify-start items-center">
          <Link href="/" className="flex items-center">
            <div className="flex items-center">
              <Image src="/images/P.O.L.jpg" alt="Logo" width={45} height={35} />
              <span className="ml-2 text-[#1D4230] text-lg font-semibold">PRESERVE OUR LANGUAGES</span>
            </div>
          </Link>
        </div>
        <div className="flex justify-start items-center gap-8">
          <NavItem href="/about">Who We Are</NavItem>
